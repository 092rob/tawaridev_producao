...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      glosa_records: {
        Row: {
          ...
          "1ª Análise - Glosa Mantida": number | null
          "1ª Análise - Glosa Recuperada": number | null
          "1ª Análise - Glosa Recursada": number | null
          "1ª Análise - Glosa Refaturada": number | null
          "1ª Análise - Pendente Retorno": number | null
          "1ª Análise - Soma Aceites e Recursos": number | null
          ...
          "Nº Parcial do Item de Recurso": number | null
          "Nome do Convenio": string | null
          "Nome paciente": string | null
          nome_paciente: string | null
          num_conta: string | null
          ...
          "Usuário Realizou Aceite": string | null
          "Usuário Realizou Recurso": string | null
          "Usuário Realizou Refaturamento": string | null
      ...
      prazos_pagamento_dashboard_access: {
        Row: {
          granted_at: string
          id: string
          user_id: string
    ...
    Functions: {
      get_api_glosa_item_columns: { Args: never; Returns: string[] }
      get_api_zg_item_column_types: {
        Args: never
        Returns: {
          column_name: string
          data_type: string
      ...
      get_api_zg_item_columns: { Args: never; Returns: string[] }
      get_api_zg_item_totals: {
        Args: {
          p_cliente?: string
          p_convenio?: string
          p_data_ate?: string
          p_data_de?: string
          p_data_pag_ate?: string
          p_data_pag_de?: string
          p_operadora?: string
          p_search?: string
        }
        Returns: {
